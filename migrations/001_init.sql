...
CREATE TABLE IF NOT EXISTS user_digest_settings (
  ...
  summary_length TEXT NOT NULL DEFAULT 'medium' CHECK (summary_length IN ('small', 'medium', 'large')),
  delivery_channel TEXT NOT NULL DEFAULT 'email',
  delivery_address TEXT,
  category_counts JSONB NOT NULL DEFAULT '{"world":0,"tech":0,"ai":0,"startups":0}',
